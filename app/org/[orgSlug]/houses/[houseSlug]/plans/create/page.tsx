// app/org/[orgSlug]/houses/[houseSlug]/plans/create/page.tsx
'use client'
...
export default function CreatePlanPage({ params }: CreatePlanPageProps) {
  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-gray-900">Create Membership Plan</h1>
          <p className="text-sm text-gray-500 mt-1">
            Create a new membership plan with pricing options
          </p>
        </div>
