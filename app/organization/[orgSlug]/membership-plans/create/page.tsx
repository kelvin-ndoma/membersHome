...
const planSchema = z.object({
  ...
  houseId: z.string().min(1, "Please select a house for this membership plan"), // REQUIRED
})
...
export default function CreateMembershipPlanPage() {
  ...
  const {
    ...
    defaultValues: {
      ...
      houseId: "", // Empty string, will trigger validation error
    },
  })
