// app/organization/[orgSlug]/houses/[houseSlug]/applications/create/page.tsx
"use client"
...
// Field schema for membership application
const fieldSchema = z.object({
  id: z.string(),
  type: z.enum(["text", "email", "tel", "textarea", "select", "radio", "checkbox", "date", "number", "url"]),
...
type ApplicationField = z.infer<typeof fieldSchema>

const fieldTypes = [
  { value: "text", label: "Full Name", icon: "👤", defaultLabel: "Full Name" },
  { value: "email", label: "Email Address", icon: "📧", defaultLabel: "Email Address" },
  { value: "tel", label: "Phone Number", icon: "📞", defaultLabel: "Phone Number" },
  { value: "textarea", label: "Paragraph", icon: "📄", defaultLabel: "Additional Information" },
  { value: "select", label: "Dropdown", icon: "📋", defaultLabel: "Select an option" },
  { value: "radio", label: "Radio Group", icon: "🔘", defaultLabel: "Choose one" },
  { value: "checkbox", label: "Checkbox", icon: "☑️", defaultLabel: "Agree to terms" },
  { value: "date", label: "Date", icon: "📅", defaultLabel: "Date" },
  { value: "number", label: "Number", icon: "🔢", defaultLabel: "Number" },
  { value: "url", label: "Website", icon: "🌐", defaultLabel: "Website" },
]
...
export default function CreateMembershipApplicationPage() {
  ...
  const addField = (type: string, defaultLabel: string) => {
    const newField: ApplicationField = {
      ...
      type: type as any,
      label: defaultLabel,
      required: type === "email", // Email is required by default
      placeholder: "",
      width: "full",
  ...
  const onSubmit = async (data: ApplicationFormData) => {
    setIsLoading(true)
    try {
      const res = await fetch(`/api/organizations/${orgSlug}/houses/${houseSlug}/membership-applications/create`, {
        method: "POST",
      ...
      toast.success("Membership application created successfully!")
      router.push(`/organization/${orgSlug}/houses/${houseSlug}/applications`)
    } catch (error: any) {
    ...
    return (
      <div className="mx-auto max-w-2xl">
        <div className="mb-6 flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold tracking-tight">Create Membership Application</h1>
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Build a membership application form for {house.name}
          </p>
        </div>
      </div>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
              ...
              <div className="flex flex-wrap gap-2">
                {fieldTypes.map((type) => (
                  <Button
                    ...
                    variant="outline"
                    size="sm"
                    onClick={() => addField(type.value, type.defaultLabel)}
                  >
            ...
            <CardContent>
              {fields.length === 0 ? (
                <div className="text-center py-12 text-muted-foreground border-2 border-dashed rounded-lg">
                  ...
                  <p>Click any button above to add application fields</p>
                  <p className="text-sm mt-2">Include required fields like Name and Email</p>
                </div>
              ) : (
        ...
        <TabsContent value="preview" className="mt-6">
          <Card>
            <CardHeader>
              <CardTitle className="text-2xl">{watch("title") || "Untitled Application"}</CardTitle>
              {watch("description") && (
