...
export default function CreateHousePage() {
  ...
  const onSubmit = async (data: CreateHouseData) => {
    setIsLoading(true)
    try {
      const res = await fetch(`/api/admin/organizations/${orgId}/houses`, {
        method: "POST",
      ...
      toast.success(`House "${data.name}" created successfully!`)
    ...
    <div className="container mx-auto max-w-2xl py-12 px-4">
      <Card>
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Create a new house within this organization
          </CardDescription>
        </CardHeader>
        <CardContent>
